...
public class CartController {
    ...
    public String viewCart(HttpSession session, Model model) {
        Integer productId = (String) session.getAttribute("productId");
        if (productId == null) {
            return "redirect:/login";
        }

        List<CartItem> cartItems = cartService.getCartItems(productId);
        double totalPrice = cartService.calculateTotalPrice(productId);
    ...
    public String addToCart(@RequestParam Integer productId,
        ...
        if (existingItem.isPresent()) {
            ...
            double newPrice = existingItem.get().getPrice() + price * quantity;
